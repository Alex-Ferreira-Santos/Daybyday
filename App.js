  ...
  render(){
    return (
      <View style={styles.container}>
        ...
        <TouchableHighlight style={[styles.touchable,styles.agua]}>
        ...
        <TouchableHighlight style={[styles.touchable,styles.alimentacao]}>
          <View style={styles.Buttoncontainer}>
        ...
        <TouchableHighlight style={[styles.touchable,styles.peso]}>
          <View style={styles.Buttoncontainer}>
        ...
        <TouchableHighlight style={[styles.touchable,styles.lista]}>
          <View style={styles.Buttoncontainer}>
        ...
        <TouchableHighlight style={[styles.touchable,styles.dormir]}>
          <View style={styles.Buttoncontainer}>
            <Image source={lua} style={styles.img}/>
            <Text style={{fontSize: 20,color: 'white'}}>Alimentação</Text>
          </View> 
        </TouchableHighlight>

        <TouchableHighlight style={[styles.touchable,styles.extra]}>
          <View style={styles.Buttoncontainer}>
